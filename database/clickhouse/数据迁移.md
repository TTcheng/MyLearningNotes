...
>  这里的 DDL 使用的是 `ATTACH` 语句，[进入文档](https://link.zhihu.com/?target=https%3A//clickhouse.tech/docs/en/sql-reference/statements/attach/) 查看 ATTACH 的作用及跟 CREATE 的区别
>  
...
![img](%E6%95%B0%E6%8D%AE%E8%BF%81%E7%A7%BB.assets/v2-abb24107cef35059695f6a61460c866f_1440w.jpg)

从官方和社区的一些资料综合来看 clickhouse-copier 功能最强大，不过考虑到数据量较少，而且对 clickhouse-copier 有些地方也不是很清楚，最终决定使用 `remote` 函数来做数据迁移。

关于别的数据迁移方案、更多的 clickhouse-copier 使用案例，可参考 Altinity 的博客 [Clickhouse-copier in practice](https://link.zhihu.com/?target=https%3A//altinity.com/blog/2018/8/22/clickhouse-copier-in-practice).
...
代码如下，需要先安装 [clickhouse-driver](https://link.zhihu.com/?target=https%3A//github.com/mymarilyn/clickhouse-driver)
...
https://www.zhihu.com/people/leonyoung
